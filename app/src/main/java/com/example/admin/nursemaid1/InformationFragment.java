 ...
 */
public class InformationFragment extends Fragment {                                                     //關於頁面，顯示華星的資訊簡介
...
//        fragment.setArguments(args);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mInfoTV = (TextView)view.findViewById(R.id.mInformationTV);
        mInfoTV.setAutoLinkMask(Linkify.WEB_URLS);
        mInfoTV.setLinkTextColor(Color.rgb(30,0,255));
